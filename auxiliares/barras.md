...
<ul class="lista-tags">
<li><a href="{{ site.url }}/404" title="404-erro">/404</a>: Página personalizada deste cantinho <a href="https://pt.wikipedia.org/wiki/HTTP_404">à resposta do protocolo</a> <code>http</code> para páginas não encontradas.</li><br/>
