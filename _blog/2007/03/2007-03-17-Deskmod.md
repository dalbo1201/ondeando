...
<aside class="aviso-caixa"><div class="aviso-texto">Fica o aviso que infelizmente a imagem que existia nesse texto se perdeu na internet devido o site de hospedagem que na época eu usava ter apagado tudo de contas grátis ou simplesmente não existir mais. Obrigado, <code>imageshack.us</code>.</div></aside>