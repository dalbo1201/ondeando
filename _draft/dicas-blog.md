...
<h2 id="bearblog">Para Bearblog, <em style="font-height:12px;">o original</em></h2>
...
<h2 id="jekyll">Para Jekyll, <em style="font-height:12px;">minha versão</em> <a href="#" class="linkcab">↑</a></h2>
...
<hr style="text-align: left; width: 33%; margin-left: 0;">
No corpo da postagem você pode usar a configuração e apresentação pelo CSS da forma que quiser.

O importante é que tenha o campo <em>image</em> e <em>caption</em> no Front Matter.
...
No layout da página da galeria você coloca a seguinte estrutura.
